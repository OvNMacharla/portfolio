...
const New = () => {
    ...
    const { setScrollToAbout } = useOutletContext<{ setScrollToAbout: React.Dispatch<React.SetStateAction<(() => void) | null>> }>();
    const { setScrollToContact } = useOutletContext<{ setScrollToContact: React.Dispatch<React.SetStateAction<(() => void) | null>> }>();
    ...
    return (
        <>
            <div className='md:flex items-center mt-[77px] md:mt-0'>
                <div className=''>
                    <h1 className='text-[28px] font-[500]'>Hey there,</h1>
                    <h1 className='text-[70px] font-[500]'>I&apos;m Ome</h1>
                    <p className='text-[#eb4a4a] text-[19px] font-[500] mb-3'> - Full-Stack Developer | MERN & Next.js </p>
                    <p className='text-[18px] text-[#808080] font-[400] '>Full-stack developer skilled in MERN stack and Next.js, building dynamic, scalable, and user-friendly web applications.</p>
                </div>
